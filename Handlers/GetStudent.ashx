...
select s.Stname as StudentName,s.StudentId,s.RegNo from s_studentinfo s  
            where  s.RegNo like '" + searchtxt + "%' order by s.Stname");
            ...
            {
                dsSearch = utl.GetDataset(@"select s.Stname as StudentName,s.StudentId,s.RegNo from s_studentinfo s    
            where   s.Stname like '" + searchtxt + "%' order by s.Stname");
