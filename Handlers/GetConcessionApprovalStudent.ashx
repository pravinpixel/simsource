<%@ WebHandler Language="C#" Class="GetConcessionApprovalStudent" %>

using System;
using System.Web;

public class GetConcessionApprovalStudent : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (context.Request.RequestType == "GET")
        {
            ...
            dsSearch = utl.GetDataset(@"exec sp_GetAdminApprovalStudentName '" + searchtxt+"','"+context.Request.QueryString["class"].ToString()+"'");
