<%@ WebHandler Language="C#" Class="GetTCStudentName" %>
...
public class GetTCStudentName : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (context.Request.RequestType == "GET")
        {
            ...
            SqlCommand cmd = new SqlCommand("sp_GetTCStudentName");

            string gender = "";
            if (context.Request.QueryString["Gender"].ToString() != "undefined")
            ...
            cmd.Parameters.AddWithValue("@class", context.Request.QueryString["class"].ToString());
