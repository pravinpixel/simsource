<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="BusPaidUnPaidReport.aspx.cs" Inherits="Reports_BusPaidUnPaidReport" %>
        ...
        <div class="box round first fullpage">
            ...
            <div align="center" class="block john-accord content-wrapper2">
                <table align="center">
                    ...
                    <tr>
                        <td>
                            <rsweb:ReportViewer ID="BusPaidUnPaidReport" runat="server" Font-Names="Verdana"
                                Font-Size="8pt" InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                                WaitMessageFont-Size="14pt" Width="1000px" Height="600px">
                                <LocalReport ReportPath="Rpt\BusPaidUnPaidReport.rdlc">
                                    <DataSources>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                                SelectMethod="GetData" TypeName="dsBusPaidUnPaidListTableAdapters.BusPaidUnPaidListTableAdapter">
                                <SelectParameters>
