...
public partial class Reports_HostelPaidUnPaidReport : System.Web.UI.Page
{
    string strClass = "";
    string strSection = "";
    string strClassID = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            HostelPaidUnPaidReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            HostelPaidUnPaidReport.LocalReport.SetParameters(new ReportParameter[] { Month });
            HostelPaidUnPaidReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
            HostelPaidUnPaidReport.LocalReport.SetParameters(new ReportParameter[] { strType });
            HostelPaidUnPaidReport.LocalReport.SetParameters(new ReportParameter[] { Class });
            ReportParameter tlPortrait = new ReportParameter("TLPORTRAIT", "false", false);
            HostelPaidUnPaidReport.LocalReport.SetParameters(new ReportParameter[] { tlPortrait });
    ...
    {
        if (HostelPaidUnPaidReport != null)
        {
            HostelPaidUnPaidReport.Dispose();
            GC.Collect();
        }    
    }
    ...
    {
        Export(HostelPaidUnPaidReport.LocalReport);
