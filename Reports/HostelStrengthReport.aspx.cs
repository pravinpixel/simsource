...
public partial class Reports_HostelStrengthReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            HostelStrengthReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            HostelStrengthReport.LocalReport.SetParameters(new ReportParameter[] { PrintDate });
            HostelStrengthReport.LocalReport.Refresh();
        }
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(HostelStrengthReport.LocalReport);
