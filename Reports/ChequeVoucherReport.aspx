<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="ChequeVoucherReport.aspx.cs" Inherits="Reports_ChequeVoucherReport" %>
        ...
        <div class="box round first fullpage">
            ...
            <div  align="center" class="block john-accord content-wrapper2">
                <table align="center">
                    ...
                    <tr>
                        <td>
                            <rsweb:ReportViewer ID="ChequeVoucherReport" runat="server" Width="1000px" 
                                Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" 
                                WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="600px">
                                <LocalReport ReportPath="Rpt\ChequeVoucherReport.rdlc">
                                    <DataSources>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                ...
                                TypeName="dsChequeVocuhersTableAdapters.Vw_GetChequeVoucherDetailsTableAdapter">
                                <SelectParameters>
