...
public partial class Reports_PhoneNoListReport : System.Web.UI.Page
{
    string strClass = "";
    string strSection = "";
    string strClassID = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            PhoneNoListReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            PhoneNoListReport.LocalReport.SetParameters(new ReportParameter[] { PrintDate });
            PhoneNoListReport.LocalReport.SetParameters(new ReportParameter[] { classSec });
        }
        else
    ...
    {
        if (PhoneNoListReport != null)
        {
            PhoneNoListReport.Dispose();
            GC.Collect();
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ReportParameter Schoolname = new ReportParameter("schoolname", dtSchool.Rows[0]["SchoolName"].ToString());
        ReportParameter PrintDate = new ReportParameter("PrintDate", System.DateTime.Now.ToString("dd/MM/yyyy"));
        ReportParameter classSec = new ReportParameter("class", Session["strClass"].ToString() + " / " + Session["strSection"].ToString());
        PhoneNoListReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
        PhoneNoListReport.LocalReport.SetParameters(new ReportParameter[] { PrintDate });
        PhoneNoListReport.LocalReport.SetParameters(new ReportParameter[] { classSec });
        PhoneNoListReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(PhoneNoListReport.LocalReport);
