<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="ParentReport.aspx.cs" EnableViewState="true" Inherits="Reports_ParentReport" %>
                    ...
                    <asp:UpdatePanel ID="ups" runat="server">
                        <ContentTemplate>
                            <table align="left">
                                ...
                                <tr>
                                    <td align="center">
                                        <rsweb:ReportViewer ID="ParentReport" runat="server" Font-Names="Verdana" 
                                            Font-Size="8pt" InteractiveDeviceInfos="(Collection)" 
                                            WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1000px">
                                            <LocalReport ReportPath="Rpt\ParentReport.rdlc">
                                                <DataSources>
                                        ...
                                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                            ...
                                            TypeName="dsParentListTableAdapters.Vw_GetOldStudentTableAdapter"> 
                                            <SelectParameters>
                                        ...
                                        <%--<CR:CrystalReportViewer ID="ParentReport" runat="server" AutoDataBind="True"
                                            GroupTreeImagesFolderUrl="" Height="1241px" ToolbarImagesFolderUrl=""
                                            ...
                                            HasSearchButton="False" HasDrilldownTabs="False" HasGotoPageButton="False"
                                            HasDrillUpButton="False" HasToggleGroupTreeButton="False" HasToggleParameterPanelButton="False"
                                            ToolPanelView="None" HasPrintButton="True" 
                                            ReuseParameterValuesOnRefresh="True" Width="846px" 
                                            onunload="ParentReport_Unload" />
                                        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                                            <Report FileName="../Rpt/cryParentReport.rpt">
                                            </Report>
                        ...
                        <Triggers>
                         <asp:PostBackTrigger ControlID="ParentReport" />
