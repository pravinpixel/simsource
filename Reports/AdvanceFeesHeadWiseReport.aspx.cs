...
public partial class Reports_AdvanceFeesHeadWiseReport : System.Web.UI.Page
{
    string sDate = "";
    string eDate = "";
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            AdvanceFeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            AdvanceFeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            AdvanceFeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            AdvanceFeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        AdvanceFeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
        AdvanceFeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        AdvanceFeesHeadWiseReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(AdvanceFeesHeadWiseReport.LocalReport);
