<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="GatePassReport.aspx.cs" Inherits="Reports_GatePassReport" %>
            ...
            <div align="center" class="block content-wrapper2">
                ...
                <ContentTemplate>
                    ...
                    <table align="left">
                        ...
                        <tr>
                            <td>
                                <rsweb:ReportViewer ID="GatePassReport" runat="server" Width="1168px" 
                                    Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" 
                                    WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="600px">
                                    <LocalReport ReportPath="Rpt\GatePassReport.rdlc">
                                        <DataSources>
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    ...
                                    TypeName="dsGatePassTableAdapters.DataTable1TableAdapter">
                                    <SelectParameters>
                ...
                <Triggers>
                <asp:PostBackTrigger ControlID="GatePassReport" />
