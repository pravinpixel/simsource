...
public partial class Reports_ScholarshipReport : System.Web.UI.Page
{
    string strClass = "";
    string strSection = "";
    string strClassID = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ScholarshipReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            ScholarshipReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });

        }

    }
    protected void BindScholarship()
    {
        utl = new Utilities();
        DataSet dsScholar = new DataSet();
        dsScholar = utl.GetDataset("sp_getscholarship");
        if (dsScholar != null && dsScholar.Tables.Count > 0 && dsScholar.Tables[0].Rows.Count > 0)
        {
            ddlScholarship.DataSource = dsScholar;
        ...
        else
        {
            ...
            ddlScholarship.DataTextField = "";
            ddlScholarship.DataValueField = "";
            ddlScholarship.DataBind();
        }
        ddlScholarship.Items.Insert(0, new ListItem("--Select---", ""));
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ScholarshipReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
        ScholarshipReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        ScholarshipReport.LocalReport.SetParameters(new ReportParameter[] { className });

        ScholarshipReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(ScholarshipReport.LocalReport);
