...
using System.Text;
public partial class Reports_DeletedReport : System.Web.UI.Page
{
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DeletedReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            DeletedReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            DeletedReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            DeletedReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        DeletedReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
        DeletedReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        DeletedReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(DeletedReport.LocalReport);
    ...
    protected void DeletedReport_Unload(object sender, EventArgs e)
    {
        if (DeletedReport != null)
        {
            DeletedReport.Dispose();
        }
    }
