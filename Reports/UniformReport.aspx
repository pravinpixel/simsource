<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="UniformReport.aspx.cs" Inherits="Reports_UniformReport" %>
        ...
        <div class="box round first fullpage">
            ...
            <div  align="center" class="block john-accord content-wrapper2">
                <table align="center">
                    ...
                    <tr>
                        <td>
                            <rsweb:ReportViewer ID="UniformReport" runat="server" Width="1000px" 
                                Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" 
                                WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="600px">
                                <LocalReport ReportPath="Rpt\UniformReport.rdlc">
                                    <DataSources>
                ...
                <asp:HiddenField ID="hfEDate" runat="server" />
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                ...
                                TypeName="dsUniformTableAdapters.sp_GetUniformListTableAdapter">
                                <SelectParameters>
