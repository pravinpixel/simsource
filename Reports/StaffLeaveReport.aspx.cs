...
public partial class Reports_StaffLeaveReport : System.Web.UI.Page
{
    string sDate = "";
    string eDate = "";
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            StaffLeaveReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            StaffLeaveReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            StaffLeaveReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            StaffLeaveReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        StaffLeaveReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
        StaffLeaveReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        StaffLeaveReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(StaffLeaveReport.LocalReport);
