...
public partial class Reports_SeatAllocationReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SeatAllocationReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            SeatAllocationReport.LocalReport.SetParameters(new ReportParameter[] { PrintDate });
            SeatAllocationReport.LocalReport.Refresh();
        }
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(SeatAllocationReport.LocalReport);
