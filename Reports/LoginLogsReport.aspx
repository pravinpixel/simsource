<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="LoginLogsReport.aspx.cs" Inherits="Reports_LoginLogReport" %>
                    ...
                    <asp:UpdatePanel ID="ups" runat="server">
                        <ContentTemplate>
                            <table align="left">
                                ...
                                <tr>
                                    <td>
                                        <rsweb:ReportViewer ID="LoginLogReport" runat="server" Width="1168px" Font-Names="Verdana"
                                            Font-Size="8pt" InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                                            WaitMessageFont-Size="14pt" Height="600px">
                                            <LocalReport ReportPath="Rpt\LoginLogsReport.rdlc">
                                                <DataSources>
                                        ...
                                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                                            SelectMethod="GetData" TypeName="dsLoginLogsTableAdapters.DataTable1TableAdapter">
                                            <SelectParameters>
                        ...
                        <Triggers>
                            <asp:PostBackTrigger ControlID="LoginLogReport" />
