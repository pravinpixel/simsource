<%@ Page Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true"
    CodeFile="CasteReport.aspx.cs" Inherits="Reports_CasteReport" %>
        ...
        <div class="box round first fullpage">
            ...
            <div class="block john-accord content-wrapper2">
                <div align="center">
                    ...
                    <rsweb:ReportViewer ID="CasteReport" runat="server" Font-Names="Verdana"
                        Font-Size="8pt" InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                        WaitMessageFont-Size="14pt" Width="1000px" Height="500px">
                        <LocalReport ReportPath="Rpt\CasteReport.rdlc">
                            <DataSources>
