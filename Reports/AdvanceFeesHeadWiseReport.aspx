<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="AdvanceFeesHeadWiseReport.aspx.cs" Inherits="Reports_AdvanceFeesHeadWiseReport" %>
            ...
            <div align="center" class="block content-wrapper2">
                ...
                <ContentTemplate>
                    ...
                    <table align="left">
                        ...
                        <tr>
                            <td>
                                <rsweb:ReportViewer ID="AdvanceFeesHeadWiseReport" runat="server" Width="1168px" 
                                    Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" 
                                    WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="600px">
                                    <LocalReport ReportPath="Rpt\AdvanceFeesReport.rdlc">
                                        <DataSources>
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    ...
                                    TypeName="dsAdvanceFeesTableAdapters.sp_GetAdvanceFeesTableAdapter">
                                    <SelectParameters>
                ...
                <Triggers>
                <asp:PostBackTrigger ControlID="AdvanceFeesHeadWiseReport" />
