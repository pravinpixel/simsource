<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="StaffLeaveReport.aspx.cs" Inherits="Reports_StaffLeaveReport" %>
            ...
            <div align="center" class="block content-wrapper2">
                ...
                <ContentTemplate>
                    ...
                    <table align="left">
                        ...
                        <tr>
                            <td>
                                <rsweb:ReportViewer ID="StaffLeaveReport" runat="server" Width="1168px" 
                                    Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" 
                                    WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="600px">
                                    <LocalReport ReportPath="Rpt\StaffLeaveReport.rdlc">
                                        <DataSources>
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                    ...
                                    TypeName="dsstaffleaveTableAdapters.SP_GetStaffLeaveReportTableAdapter">
                                    <SelectParameters>
                ...
                <Triggers>
                <asp:PostBackTrigger ControlID="StaffLeaveReport" />
