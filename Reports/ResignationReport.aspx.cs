...
public partial class Reports_ResignationReport : System.Web.UI.Page
{
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ResignationReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            ResignationReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ResignationReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(ResignationReport.LocalReport);
