...
public partial class Reports_SMSReport : System.Web.UI.Page
{
    string sDate = "";
    string eDate = "";
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SMSReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            SMSReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            SMSReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            SMSReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        SMSReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
        SMSReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        SMSReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(SMSReport.LocalReport);
