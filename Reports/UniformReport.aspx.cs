...
using System.Text;
public partial class Reports_UniformReport : System.Web.UI.Page
{
    Utilities utl = null;
    string sqlstr = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            UniformReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            UniformReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
    ...
    {
        Export(UniformReport.LocalReport);
