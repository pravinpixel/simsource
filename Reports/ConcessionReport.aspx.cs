...
public partial class Reports_ConcessionReport : System.Web.UI.Page
{
    string strClass = "";
    string strSection = "";
    string strClassID = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ConcessionReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            ConcessionReport.LocalReport.SetParameters(new ReportParameter[] { Month });
            ConcessionReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
            ConcessionReport.LocalReport.SetParameters(new ReportParameter[] { Class });
            ReportParameter tlPortrait = new ReportParameter("TLPORTRAIT", "false", false);
            ConcessionReport.LocalReport.SetParameters(new ReportParameter[] { tlPortrait });
    ...
    {
        if (ConcessionReport != null)
        {
            ConcessionReport.Dispose();
            GC.Collect();
        }
    }
    ...
    {
        Export(ConcessionReport.LocalReport);
