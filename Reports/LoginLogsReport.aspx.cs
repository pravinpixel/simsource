...
public partial class Reports_LoginLogReport : System.Web.UI.Page
{
    string sDate = "";
    string eDate = "";
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            LoginLogReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            LoginLogReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            LoginLogReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            LoginLogReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        LoginLogReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
        LoginLogReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        LoginLogReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(LoginLogReport.LocalReport);
