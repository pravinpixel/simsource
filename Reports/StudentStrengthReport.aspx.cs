...
public partial class Reports_StudentStrengthReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            StudentStrengthReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            StudentStrengthReport.LocalReport.SetParameters(new ReportParameter[] { PrintDate });
            StudentStrengthReport.LocalReport.Refresh();
        }
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(StudentStrengthReport.LocalReport);
