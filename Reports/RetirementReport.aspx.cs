...
public partial class Reports_RetirementReport : System.Web.UI.Page
{
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            RetirementReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            RetirementReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        RetirementReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(RetirementReport.LocalReport);
