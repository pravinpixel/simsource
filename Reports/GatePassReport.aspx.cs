...
public partial class Reports_GatePassReport : System.Web.UI.Page
{
    string sDate = "";
    string eDate = "";
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            GatePassReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            GatePassReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            GatePassReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            GatePassReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        GatePassReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
        GatePassReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        GatePassReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(GatePassReport.LocalReport);
