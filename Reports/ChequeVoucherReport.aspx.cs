...
using System.Text;
public partial class Reports_ChequeVoucherReport : System.Web.UI.Page
{
    Utilities utl = null;
    string sqlstr = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ChequeVoucherReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            ChequeVoucherReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            ChequeVoucherReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            ChequeVoucherReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ChequeVoucherReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
        ChequeVoucherReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        ChequeVoucherReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(ChequeVoucherReport.LocalReport);
