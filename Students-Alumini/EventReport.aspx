<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="EventReport.aspx.cs" Inherits="Reports_EventReport" %>
                    ...
                    <tr>
                        <td>
                            <rsweb:ReportViewer ID="EventReport" runat="server" Width="1000px" Font-Names="Verdana"
                                ...
                                <LocalReport ReportPath="Rpt\EventReport.rdlc">
                                    <DataSources>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                                ...
                                TypeName="dsEventTableAdapters.sp_GetEventListTableAdapter">
