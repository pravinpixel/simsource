<%@ Page Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true"
    CodeFile="EOLLeaveApplication.aspx.cs" Inherits="Staffs_EOLLeaveApplication" %>
    ...
    <script type="text/javascript">
        ...
        function SaveDetails() {
            if ($('#aspnetForm').valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../Staffs/EOLLeaveApplication.aspx/UpdateLeave",
                    data: parameters,
        ...
        function GetLeaveApproval(StaffLeaveId,LeaveId) {
            if ($("[id*=hfViewPrm]").val() == 'true') {
                ...
                $.ajax({
                    type: "POST",
                    url: "../Staffs/EOLLeaveApplication.aspx/GetLeaveApproval",
                    ...
                    <table class="formtc" width="100%">
                        ...
                        <tr>
                            <td height="50" align="center" valign="bottom" style="padding-top: 0px;">
                                <span class="leave-title">EOL LEAVE APPLICATION</span>
                            </td>
                        </tr>
                        <tr>
                            <td height="50" align="center" valign="bottom" style="padding-top: 0px;">
