<%@ Page Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true"
    CodeFile="ViewLeaveApplication.aspx.cs" Inherits="Staffs_ViewLeaveApplication" %>
    ...
    <script type="text/javascript">
        ...
        function SaveDetails() {
            if ($('#aspnetForm').valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../Staffs/ViewLeaveApplication.aspx/UpdateLeave",
                    data: parameters,
        ...
        function GetLeaveApproval(StaffLeaveId, LeaveId) {
            if ($("[id*=hfViewPrm]").val() == 'true') {
                ...
                $.ajax({
                    type: "POST",
                    url: "../Staffs/ViewLeaveApplication.aspx/GetLeaveApproval",
                    ...
                    <table class="formtc" width="100%">
                        ...
                        <tr>
                            <td height="50" align="center" valign="bottom" style="padding-top: 0px;">
                                <span class="leave-title">LEAVE APPLICATION</span>
                            </td>
                        </tr>
                        <tr>
                            <td height="50" align="center" valign="bottom" style="padding-top: 0px;">
                            ...
                            <td height="30" class="">
                                <table border="0" cellspacing="0" cellpadding="5" width="100%" class="leaveapp">
                                    ...
                                    <tr>
                                        ...
                                        <td class="leaveapp-brd-tlr">
                                            <asp:TextBox runat="server" ID="txtRemarks" TextMode="MultiLine" CssClass="jsrequired" Width="350px" 
                                                Font-Bold="True" Font-Names="Times New Roman"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="30" class="leaveapp-brd-tl">
